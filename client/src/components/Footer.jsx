...
const footerData = [
  ...
  },
  {
    ...
    svg: (
      <svg
        className="as-styledAboutIcon"
        focusable="false"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
        <path d="M19,5H14.15A2.88,2.88,0,0,0,12,6,2.88,2.88,0,0,0,9.86,5H2V19h8.57A1.28,1.28,0,0,1,12,20s0,0,0,0l0,0a1.26,1.26,0,0,1,1.41-1H22V8ZM11.5,18.09a2.82,2.82,0,0,0-.71-.09H3V6h7.07A1.43,1.43,0,0,1,11.5,7.43ZM21,18H13.22a3,3,0,0,0-.72.09V7.43A1.43,1.43,0,0,1,13.93,6H18V9h3Z"></path>
      </svg>
    ),
    items: [
      "This is IKEA",
  ...
  return (
    <div className="as-footerWrapper">
      {footerData.map((footer, i) => (
        <FooterMenu key={`footer-menu-${i}`} {...footer} />
      ))}
    </div>
  );
};
...
<div className="as-shopFamily">
  ...
  <div className="as-styledShopList">
    ...
    <div className="as-styledShopListEntry">
      IKEA Credit Card Management{" "}
    </div>
  </div>
</div>
...
<div className="as-aboutFamily">
  ...
  <div className="as-styledAboutList">
    ...
    <div className="as-styledAboutListEntry">
      Creating Safer Homes Together{" "}
    </div>
  </div>
</div>
